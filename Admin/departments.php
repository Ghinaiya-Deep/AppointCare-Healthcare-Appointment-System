    ...
    <div class="main-container">
        ...
        <div class="container-wrapper">
            ...
            <div class="container">
                ...
                <a href="add_department.php" style="float: right; padding: 10px 15px; background: green; color: white; text-decoration: none; border-radius: 5px;">
                    + Add Departments
                </a>
                <br><br>
                <table>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="edit_department.php?id=<?php echo $row['id']; ?>" class="action-btn edit-btn">Edit</a>
                                        <a href="delete_department.php?id=<?php echo $row['id']; ?>" class="action-btn delete-btn">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } else { ?>
                            <tr>
                                <td colspan="9" style="text-align: center;">No Departments found.</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
